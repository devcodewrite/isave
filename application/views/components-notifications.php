...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/components-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:30 GMT -->
<head>
<meta charset="utf-8">
...
<div>Notifications
<div class="page-title-subheading">Notifications represent one of the best ways to give feedback for various users actions.</div>
</div>
</div>
...
<button type="button" class="btn btn-link text-danger" id="cleartoasts">Clear
Toasts</button>
...
<button type="button" data-type="question" class="btn btn-primary btn-show-swal">Show
Alert</button>
</div>
</div>
</div>
...
<button type="button" data-type="danger" class="btn btn-danger btn-show-swal">Show
Alert</button>
</div>
</div>
</div>
...
<button type="button" data-type="info" class="btn btn-info btn-show-swal">Show
Alert</button>
</div>
</div>
</div>
...
<button type="button" data-type="warning" class="btn btn-warning btn-show-swal">Show
Alert</button>
</div>
</div>
</div>
...
<div class="mb-3 text-center card">
<div class="card-body">
<h5 class="card-title">Custom Animation</h5>
...
<div class="alert alert-primary fade show" role="alert">This is a primary alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-secondary fade show" role="alert">This is a secondary alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-success fade show" role="alert">This is a success alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-danger fade show" role="alert">This is a danger alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-warning fade show" role="alert">This is a warning alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-info fade show" role="alert">This is a info alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-light fade show" role="alert">This is a light alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
<div class="alert alert-dark fade show" role="alert">This is a dark alert with
<a href="javascript:void(0);" class="alert-link">an example link</a>. Give it a
click if you like.
</div>
</div>
