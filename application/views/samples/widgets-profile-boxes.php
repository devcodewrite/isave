...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/widgets-profile-boxes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:33 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta http-equiv="Content-Language" content="en">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Profile Boxes - These boxes are usually for dashboard elements centered around users and profiles.</title>
...
<li>
<a href="widgets-profile-boxes.html" class="mm-active">
...
<div class="widget-subheading opacity-10">
<span class="pr-2"><b class="text-danger">12</b> Leads</span>
<span><b class="text-warning">$56,24</b> Totals</span>
</div>
</div>
<div class="widget-content-right">
<div class="icon-wrapper m-0">
...
<div class="widget-content-wrapper">
<div class="widget-content-left center-elem mr-2">
<i class="pe-7s-file text-muted fsize-2"></i></div>
<div class="widget-content-left">
<div class="widget-heading">Example file 2</div>
</div>
<div class="widget-content-right widget-content-actions">
...
<div class="widget-content-left mr-3">
<div class="icon-wrapper m-0">
<b class="text-primary"><span>764</span></b>
</div>
</div>
<div class="widget-content-left">
<div class="widget-heading text-dark opacity-7">March Totals</div>
<div class="widget-subheading opacity-10"><span class="pr-2">
<b class="text-danger">12</b> new leads,</span><span>
<b class="text-dark">$56,24</b> in sales</span>
</div>
</div>
<div class="widget-content-right">
<div class="icon-wrapper m-0">
...
<div class="col-sm-6">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
 <i class="lnr-map btn-icon-wrapper btn-icon-lg mb-3"> </i>Sales Reports
</button>
</div>
<div class="col-sm-6">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
...
<div class="col-sm-6">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
<i class="lnr-heart btn-icon-wrapper btn-icon-lg mb-3"> </i>Successful Tasks
</button>
</div>
</div>
</div>
...
<div class="menu-header-content">
<div class="avatar-icon-wrapper mb-3 avatar-icon-xl">
<div class="avatar-icon"><img src="assets/images/avatars/2.jpg" alt="Avatar 5">
</div>
</div>
<div>
<h5 class="menu-header-title">Kalem Forster</h5>
<h6 class="menu-header-subtitle">Applications Technician</h6>
</div>
<div class="menu-header-btn-pane pt-1">
<button class="btn-icon btn btn-dark btn-sm">
<i class="pe-7s-config btn-icon-wrapper"></i>View Complete Profile
</button>
</div>
</div>
</div>
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/widgets-profile-boxes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:34 GMT -->
</html>