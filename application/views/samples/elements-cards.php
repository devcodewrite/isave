...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/elements-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:15 GMT -->
<head>
<meta charset="utf-8">
...
<li>
<a href="elements-cards.html" class="mm-active">
...
<div>Cards
<div class="page-title-subheading">Wide selection of cards with multiple styles, borders, actions and hover effects.</div>
</div>
</div>
...
<p class="mb-0">Lorem Ipsum has been the industry's standard dummy text ever since the
...
<div class="card-header">Header</div>
<div class="card-body">With supporting text below as a natural lead-in to additional
content.</div>
...
<a data-toggle="tab" href="#tab-eg3-0" class="btn-shadow active btn btn-dark">Tab 1</a>
...
<p>Like Aldus PageMaker including versions of Lorem. It has survived not only
...
<div class="btn-actions-pane-right actions-icon-btn">
<div role="group" class="btn-group-sm nav btn-group">
<a data-toggle="tab" href="#tab-eg2-0" class="btn-pill pl-3 active btn btn-focus">Tab 1</a>
<a data-toggle="tab" href="#tab-eg2-1" class="btn btn-focus">Tab 2</a>
<a data-toggle="tab" href="#tab-eg2-2" class="btn-pill pr-3  btn btn-focus">Tab 3</a>
</div>
</div>
</div>
<div class="card-body">
...
<div class="main-card mb-3 card">
<div class="card-header">
<i class="header-icon lnr-graduation-hat icon-gradient bg-happy-itmeo"> </i>Header Menu
<div class="btn-actions-pane-right actions-icon-btn">
<div role="group" class="btn-group-sm btn-group">
<div class="btn-group dropdown">
<button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="btn-pill pl-3 dropdown-toggle btn btn-warning">Left
</button>
<div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-rounded dropdown-menu-right dropdown-menu">
<h6 tabindex="-1" class="dropdown-header">Header</h6>
...
<ul class="nav">
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg1-0" class="active nav-link">Tab 1</a>
</li>
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg1-1" class="nav-link">Tab 2</a>
</li>
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg1-2" class="nav-link">Tab 3</a>
</li>
</ul>
</div>
<div class="card-body">
...
<div class="d-block text-right card-footer">
<button class="btn-wide btn-shadow btn btn-danger">Delete</button>
</div>
</div> 
<div class="mb-3 card">
<div class="card-header">
...
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg-0" class="active nav-link">Tab 1</a>
</li>
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg-1" class="nav-link">Tab 2</a>
</li>
<li class="nav-item">
<a data-toggle="tab" href="#tab-eg-2" class="nav-link">Tab 3</a>
</li>
</ul>
</div>
<div class="card-body">
...
<div class="card-border mb-3 card card-body border-focus">
<h5 class="card-title">Focus Card Border</h5>
With supporting text below as a natural lead-in to additional content.
</div>
<div class="card-border mb-3 card card-body border-alternate">
<h5 class="card-title">Alternate Card Border</h5>
With supporting text below as a natural lead-in to additional content.
</div>
</div>
<div class="col-md-4">
