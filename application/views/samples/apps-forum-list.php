...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/apps-forum-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:01 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta http-equiv="Content-Language" content="en">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Forum Listing - Example layout page for forum listing</title>
...
<ul class="mm-show">
<li>
<a href="apps-forum-list.html" class="mm-active">
...
<div>Forum Listing
<div class="page-title-subheading">Example layout page for forum listing</div>
</div>
</div>
...
</div> <h4 class="d-flex flex-wrap justify-content-between align-items-center mb-3">
<div>Forums</div>
...
<div class="row no-gutters align-items-center">
<div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">Getting
started</a></div>
...
<a href="javascript:void(0)" class="d-block text-truncate">Aliquam et velit vel nisi
egestas pulvinar sit amet ac tellus</a>
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Announcements</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">43</div>
<div class="col-3">112</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/3.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Sed scelerisque justo
elit, sed maximus arcu fringilla at</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="card-body py-3">
<div class="row no-gutters align-items-center">
<div class="col"><a href="javascript:void(0)" class="text-big font-weight-semibold">Guides</a></div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
...
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Donec lobortis molestie
sem, ac consectetur turpis egestas quis</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="col font-weight-bold pl-3">Purchasing</div>
<div class="d-none d-md-block col-6 text-muted">
<div class="row no-gutters align-items-center">
<div class="col-3">Threads</div>
<div class="col-3">Replies</div>
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Payments</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">632</div>
<div class="col-3">4234</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/5.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Donec tellus nibh,
efficitur a interdum id, vulputate ultrices mi</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Shipping</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">53</div>
<div class="col-3">116</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/5.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Pellentesque in consequat
erat</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Products</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">33</div>
<div class="col-3">86</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/7.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Vivamus maximus lectus
sed finibus pellentesque</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="card-header pl-0 pr-0">
<div class="row w-100 no-gutters align-items-center">
<div class="col font-weight-bold pl-3">Partnership</div>
<div class="d-none d-md-block col-6 text-muted">
<div class="row no-gutters align-items-center">
<div class="col-3">Threads</div>
<div class="col-3">Replies</div>
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Requirements</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">58</div>
<div class="col-3">176</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/8.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Nullam luctus eget odio
in bibendum</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Conditions</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">134</div>
<div class="col-3">568</div>
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/3.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Donec rutrum metus mi,
eget consequat metus posuere non</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="card-header pl-0 pr-0">
<div class="row w-100 no-gutters align-items-center">
<div class="col font-weight-bold pl-3">Support</div>
<div class="d-none d-md-block col-6 text-muted">
<div class="row no-gutters align-items-center">
<div class="col-3">Threads</div>
<div class="col-3">Replies</div>
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Common questions</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
...
<img style="width: 40px; height: auto;" src="assets/images/avatars/2.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Integer eu tortor
purus</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
...
<div class="row no-gutters align-items-center">
<div class="col">
<a href="javascript:void(0)" class="text-big font-weight-semibold">Site issues</a>
</div>
<div class="d-none d-md-block col-6">
<div class="row no-gutters align-items-center">
<div class="col-3">12</div>
...
<div class="media col-6 align-items-center">
<img style="width: 40px; height: auto;" src="assets/images/avatars/6.jpg" alt="" class="d-block ui-w-30 rounded-circle">
<div class="media-body flex-truncate ml-2">
<a href="javascript:void(0)" class="d-block text-truncate">Nullam luctus eget odio
in bibendum</a>
<div class="text-muted small text-truncate">1d ago &nbsp;·&nbsp;
