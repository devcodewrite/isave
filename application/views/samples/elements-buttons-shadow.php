...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/elements-buttons-shadow.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:02 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta http-equiv="Content-Language" content="en">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Shadow Buttons - These buttons are examples of buttons with drop shadows attached.</title>
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no" />
<meta name="description" content="These buttons are examples of buttons with drop shadows attached.">
...
<li>
<a href="elements-buttons-shadow.html" class="mm-active">
...
<button class="mb-2 mr-2 btn btn-shadow btn-primary">Primary</button>
<button class="mb-2 mr-2 btn btn-shadow btn-secondary">Secondary</button>
<button class="mb-2 mr-2 btn btn-shadow btn-success">Success</button>
<button class="mb-2 mr-2 btn btn-shadow btn-info">Info</button>
<button class="mb-2 mr-2 btn btn-shadow btn-warning">Warning</button>
<button class="mb-2 mr-2 btn btn-shadow btn-danger">Danger</button>
<button class="mb-2 mr-2 btn btn-shadow btn-focus">Focus</button>
<button class="mb-2 mr-2 btn btn-shadow btn-alternate">Alt</button>
<button class="mb-2 mr-2 btn btn-shadow btn-light">Light</button>
<button class="mb-2 mr-2 btn btn-shadow btn-dark">Dark</button>
<button class="mb-2 mr-2 btn btn-shadow btn-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Hover Shadow No Borders</h5>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-primary">Primary</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-secondary">Secondary</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-success">Success</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-info">Info</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-warning">Warning</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-danger">Danger</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-focus">Focus</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-alternate">Alt</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-light">Light</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-dark">Dark</button>
<button class="mb-2 mr-2 border-0 btn-transition btn btn-shadow btn-outline-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-secondary">Secondary</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-success">Success</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-info">Info</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-warning">Warning</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-danger">Danger</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-focus">Focus</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-alternate">Alt</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-light">Light</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-dark">Dark</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn btn-shadow btn-primary active">Primary</button>
<button class="mb-2 mr-2 btn btn-shadow btn-secondary active">Secondary</button>
<button class="mb-2 mr-2 btn btn-shadow btn-success active">Success</button>
<button class="mb-2 mr-2 btn btn-shadow btn-info active">Info</button>
<button class="mb-2 mr-2 btn btn-shadow btn-warning active">Warning</button>
<button class="mb-2 mr-2 btn btn-shadow btn-danger active">Danger</button>
<button class="mb-2 mr-2 btn btn-shadow btn-focus active">Focus</button>
<button class="mb-2 mr-2 btn btn-shadow btn-alternate active">Alt</button>
<button class="mb-2 mr-2 btn btn-shadow btn-light active">Light</button>
<button class="mb-2 mr-2 btn btn-shadow btn-dark active">Dark</button></button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-primary disabled">Primary</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-secondary disabled">Secondary</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-success disabled">Success</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-info disabled">Info</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-warning disabled">Warning</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-danger disabled">Danger</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-focus disabled">Focus</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-alternate disabled">Alt</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-light disabled">Light</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-dark disabled">Dark</button>
<button disabled="" class="mb-2 mr-2 btn btn-shadow btn-link disabled">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn btn-shadow btn-primary btn-lg btn-block">Block Large</button>
<button class="mb-2 mr-2 btn btn-shadow btn-primary btn-block">Block Normal</button>
<button class="mb-2 mr-2 btn btn-shadow btn-primary btn-sm btn-block">Block Small</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="btn-wide mb-2 mr-2 btn btn-shadow btn-primary btn-lg">Wider Large</button>
<button class="btn-wide mb-2 mr-2 btn btn-shadow btn-primary">Wider Normal</button>
<button class="btn-wide mb-2 mr-2 btn btn-shadow btn-primary btn-sm">Wider Small</button>
</div>
</div>
</div>
<div class="main-card mb-3 card">
...
<div class="text-center">
<button class="mb-2 mr-2 btn btn-shadow btn-primary btn-lg">Large</button>
<button class="mb-2 mr-2 btn btn-shadow btn-primary">Normal</button>
<button class="mb-2 mr-2 btn btn-shadow btn-primary btn-sm">Small</button>
</div>
</div>
</div>
</div>
...
<button type="button" class="btn btn-shadow btn-primary">One</button>
<button type="button" class="btn btn-shadow btn-primary">Two</button>
<button type="button" class="btn btn-shadow btn-primary">Three</button>
</div>
<div class="divider">
</div>
<div role="group" class="btn-group">
<button type="button" class="btn btn-shadow btn-danger">One</button>
<button type="button" class="btn btn-shadow btn-danger">Two</button>
<button type="button" class="btn btn-shadow btn-danger">Three</button>
</div>
<div class="divider">
</div>
<div role="group" class="btn-group-lg btn-group btn-group-toggle">
<button type="button" class="btn btn-shadow btn-alternate">One</button>
<button type="button" class="btn btn-shadow btn-alternate">Two</button>
<button type="button" class="btn btn-shadow btn-alternate">Three</button>
</div>
</div>
</div>
</div>
...
<input type="radio" name="options" id="option4" autocomplete="off"> One
</label>
<label class="btn btn-shadow btn-warning">
<input type="radio" name="options" id="option5" autocomplete="off"> Two
</label>
<label class="btn btn-shadow btn-warning">
<input type="radio" name="options" id="option6" autocomplete="off"> Three
</label>
</div>
<div class="divider">
</div>
...
<input type="radio" name="options" id="option7" autocomplete="off"> One
</label>
<label class="btn btn-shadow btn-focus">
<input type="radio" name="options" id="option8" autocomplete="off"> Two
</label>
<label class="btn btn-shadow btn-focus">
<input type="radio" name="options" id="option9" autocomplete="off"> Three
</label>
</div>
</div>
</div>
...
<div class="card-body">
<h5 class="card-title">Hover Shadow</h5>
<button class="mb-2 mr-2 btn btn-shadow-primary btn-outline-primary">Primary</button>
<button class="mb-2 mr-2 btn btn-shadow-secondary btn-outline-secondary">Secondary</button>
<button class="mb-2 mr-2 btn btn-shadow-success btn-outline-success">Success</button>
<button class="mb-2 mr-2 btn btn-shadow-info btn-outline-info">Info</button>
<button class="mb-2 mr-2 btn btn-shadow-warning btn-outline-warning">Warning</button>
<button class="mb-2 mr-2 btn btn-shadow-danger btn-outline-danger">Danger</button>
<button class="mb-2 mr-2 btn btn-shadow-focus btn-outline-focus">Focus</button>
<button class="mb-2 mr-2 btn btn-shadow-alternate btn-outline-alternate">Alt</button>
<button class="mb-2 mr-2 btn btn-shadow-light btn-outline-light">Light</button>
<button class="mb-2 mr-2 btn btn-shadow-dark btn-outline-dark">Dark</button>
<button class="mb-2 mr-2 btn btn-shadow-link btn-outline-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<input type="radio" name="options" id="option111" autocomplete="off" checked> Active One
</label>
<label class="btn btn-shadow btn-outline-primary">
<input type="radio" name="options" id="option122" autocomplete="off" checked> Active Two
</label>
<label class="btn btn-shadow btn-outline-primary">
<input type="radio" name="options" id="option133" autocomplete="off" checked> Active Three
</label>
</div>
<div class="divider"></div>
<div role="group" class="mb-2 btn-group btn-group-toggle" data-toggle="buttons">
<label class="btn btn-shadow btn-outline-success">
<input type="radio" name="options" id="option144" autocomplete="off" checked> Active One
</label>
<label class="btn btn-shadow btn-outline-success">
<input type="radio" name="options" id="option155" autocomplete="off" checked> Active Two
</label>
<label class="btn btn-shadow btn-outline-success">
<input type="radio" name="options" id="option166" autocomplete="off" checked> Active Three
</label>
</div>
<div class="divider"></div>
...
<input type="radio" name="options" id="option177" autocomplete="off" checked> Active One
</label>
<label class="btn btn-shadow btn-outline-info">
<input type="radio" name="options" id="option188" autocomplete="off" checked> Active Two
</label>
<label class="btn btn-shadow btn-outline-info">
<input type="radio" name="options" id="option199" autocomplete="off" checked> Active Three
</label>
</div>
</div>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-secondary" data-style="expand-right">
 <span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
 <span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="card-body">
<h5 class="card-title">Hover Shadow</h5>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-primary btn-outline-primary">Primary</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-secondary btn-outline-secondary">Secondary</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-success btn-outline-success">Success</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-info btn-outline-info">Info</button>
 <button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-warning btn-outline-warning">Warning</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-danger btn-outline-danger">Danger</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-focus btn-outline-focus">Focus</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-alternate btn-outline-alternate">Alt</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-light btn-outline-light">Light</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-dark btn-outline-dark">Dark</button>
<button class="mb-2 mr-2 btn-outline-2x btn btn-shadow-link btn-outline-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
 </div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-outline-2x btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="card-body">
<h5 class="card-title">Hover Shadow</h5>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-primary btn-shadow-primary">Primary</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-secondary btn-shadow-secondary">Secondary</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-success btn-shadow-success">Success</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-info btn-shadow-info">Info</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-warning btn-shadow-warning">Warning</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-danger btn-shadow-danger">Danger</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-focus btn-shadow-focus">Focus</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-alternate btn-shadow-alternate">Alt</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-light btn-shadow-light">Light</button>
<button class="mb-2 mr-2 btn-dashed btn btn-outline-dark btn-shadow-dark">Dark</button>
<button class="mb-2 mr-2 btn-dashed btn btn-shadow-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
 </button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
 </div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-dashed btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="card-body">
<h5 class="card-title">Hover Shadow</h5>
<button class="mb-2 mr-2 btn btn-gradient-primary btn-primary btn-shadow-primary">Primary</button>
<button class="mb-2 mr-2 btn btn-gradient-secondary btn-secondary btn-shadow-secondary">Secondary</button>
 <button class="mb-2 mr-2 btn btn-gradient-success btn-success btn-shadow-success">Success</button>
<button class="mb-2 mr-2 btn btn-gradient-info btn-info btn-shadow-info">Info</button>
<button class="mb-2 mr-2 btn btn-gradient-warning btn-warning btn-shadow-warning">Warning</button>
<button class="mb-2 mr-2 btn btn-gradient-danger btn-danger btn-shadow-danger">Danger</button>
<button class="mb-2 mr-2 btn btn-gradient-focus btn-focus btn-shadow-focus">Focus</button>
<button class="mb-2 mr-2 btn btn-gradient-alternate btn-alternate btn-shadow-alternate">Alt</button>
<button class="mb-2 mr-2 btn btn-gradient-light btn-light btn-shadow-light">Light</button>
<button class="mb-2 mr-2 btn btn-gradient-dark btn-dark btn-shadow-dark">Dark</button>
<button class="mb-2 mr-2 btn btn-gradient-link btn-link btn-shadow-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
 </button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
 </button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-shadow btn-gradient-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
