...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/forms-input-selects.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:34 GMT -->
<head>
<meta charset="utf-8">
...
<li>
<a href="forms-input-selects.html" class="mm-active">
...
<div class="page-title-icon">
 <i class="pe-7s-gift icon-gradient bg-mixed-hopes"></i>
</div>
<div>Multi Select
<div class="page-title-subheading">Create fancy multi select dropdown menus for a better user experience.</div>
</div>
</div>
