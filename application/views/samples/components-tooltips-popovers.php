...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/components-tooltips-popovers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:30 GMT -->
<head>
<meta charset="utf-8">
...
<div class="page-title-subheading">These React components are used to add interaction or extra information for your app&#x27;s content.</div>
</div>
</div>
...
<div class="text-center">
<button type="button" data-title="Warm Flame" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-warm-flame" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Warm Flame
</button>
<button type="button" data-title="Night Fade" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-night-fade" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Night Fade
</button>
<button type="button" data-title="Sunny Morning" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-sunny-morning" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Sunny Morning
</button>
<button type="button" data-title="Tempting Azure" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-tempting-azure" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Tempting Azure
</button>
<button type="button" data-title="Amy Crisp" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-amy-crisp" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Amy Crisp
</button>
<button type="button" data-title="Heavy Rain" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-heavy-rain" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Heavy Rain
</button>
<button type="button" data-title="Mean Fruit" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-mean-fruit" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Mean Fruit
</button>
<button type="button" data-title="Malibu Beach" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-malibu-beach" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Malibu Beach
</button>
<button type="button" data-title="Deep Blue" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-deep-blue" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Deep Blue
</button>
<button type="button" data-title="Ripe Malin" data-toggle="popover-custom-bg" data-bg-class="text-light bg-ripe-malin" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Ripe Malin
</button>
<button type="button" data-title="Arielle Smile" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-arielle-smile" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Arielle Smile
</button>
<button type="button" data-title="Plum Plate" data-toggle="popover-custom-bg" data-bg-class="text-light bg-plum-plate" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Plum Plate
</button>
<button type="button" data-title="Happy Fisher" data-toggle="popover-custom-bg" data-bg-class="text-dark bg-happy-fisher" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Happy Fisher
</button>
<button type="button" data-title="Happy Itmeo" data-toggle="popover-custom-bg" data-bg-class="text-light bg-happy-itmeo" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Happy Itmeo
</button>
<button type="button" data-title="Mixed Hopes" data-toggle="popover-custom-bg" data-bg-class="text-light bg-mixed-hopes" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Mixed Hopes
</button>
<button type="button" data-title="Strong Bliss" data-toggle="popover-custom-bg" data-bg-class="text-light bg-strong-bliss" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Strong Bliss
</button>
<button type="button" data-title="row-Early" data-toggle="popover-custom-bg" data-bg-class="text-light bg-grow-early" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Grow-Early
</button>
<button type="button" data-title="Love Kiss" data-toggle="popover-custom-bg" data-bg-class="text-light bg-love-kiss" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Love Kiss
</button>
<button type="button" data-title="Premium Dark" data-toggle="popover-custom-bg" data-bg-class="text-light bg-premium-dark" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Premium Dark
</button>
<button type="button" data-title="Happy Green" data-toggle="popover-custom-bg" data-bg-class="text-light bg-happy-green" data-content="Example popover with custom background from CSS helper class!" class="mr-2 mb-2 btn btn-secondary">Happy Green
</button>
</div>
</div>
</div>
...
<div class="dropdown-menu-header">
<div class="dropdown-menu-header-inner bg-success">
<div class="menu-header-image opacity-5" style="background-image: url('assets/images/dropdown-header/abstract4.jpg');">
</div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
...
<div class="menu-header-image opacity-5" style="background-image: url('assets/images/dropdown-header/city3.jpg');">
</div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
...
<div class="menu-header-image opacity-5" style="background-image: url('assets/images/dropdown-header/abstract1.jpg');">
</div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Dark Tooltips</h5>
<div class="text-center">
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Light Tooltips</h5>
<div class="text-center">
