...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/elements-buttons-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:01 GMT -->
<head>
<meta charset="utf-8">
...
<h5 class="card-title">Solid</h5>
 <button class="mb-2 mr-2 btn btn-primary">Primary</button>
<button class="mb-2 mr-2 btn btn-secondary">Secondary</button>
<button class="mb-2 mr-2 btn btn-success">Success</button>
<button class="mb-2 mr-2 btn btn-info">Info</button>
<button class="mb-2 mr-2 btn btn-warning">Warning</button>
<button class="mb-2 mr-2 btn btn-danger">Danger</button>
<button class="mb-2 mr-2 btn btn-focus">Focus</button>
<button class="mb-2 mr-2 btn btn-alternate">Alt</button>
<button class="mb-2 mr-2 btn btn-light">Light</button>
<button class="mb-2 mr-2 btn btn-dark">Dark</button>
<button class="mb-2 mr-2 btn btn-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn-transition btn btn-outline-primary">Primary</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-secondary">Secondary</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-success">Success</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-info">Info</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-warning">Warning</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-danger">Danger</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-focus">Focus</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-alternate">Alt</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-light">Light</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-dark">Dark</button>
<button class="mb-2 mr-2 btn-transition btn btn-outline-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn-hover-shine btn btn-primary">Primary</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-secondary">Secondary</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-success">Success</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-info">Info</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-warning">Warning</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-danger">Danger</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-focus">Focus</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-alternate">Alt</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-light">Light</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-dark">Dark</button>
<button class="mb-2 mr-2 btn-hover-shine btn btn-link">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn btn-primary active">Primary</button>
<button class="mb-2 mr-2 btn btn-secondary active">Secondary</button>
<button class="mb-2 mr-2 btn btn-success active">Success</button>
<button class="mb-2 mr-2 btn btn-info active">Info</button>
<button class="mb-2 mr-2 btn btn-warning active">Warning</button>
<button class="mb-2 mr-2 btn btn-danger active">Danger</button>
<button class="mb-2 mr-2 btn btn-focus active">Focus</button>
<button class="mb-2 mr-2 btn btn-alternate active">Alt</button>
<button class="mb-2 mr-2 btn btn-light active">Light</button>
<button class="mb-2 mr-2 btn btn-dark active">Dark</button>
<button class="mb-2 mr-2 btn btn-link active">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button disabled="" class="mb-2 mr-2 btn btn-primary disabled">Primary</button>
<button disabled="" class="mb-2 mr-2 btn btn-secondary disabled">Secondary</button>
<button disabled="" class="mb-2 mr-2 btn btn-success disabled">Success</button>
<button disabled="" class="mb-2 mr-2 btn btn-info disabled">Info</button>
<button disabled="" class="mb-2 mr-2 btn btn-warning disabled">Warning</button>
<button disabled="" class="mb-2 mr-2 btn btn-danger disabled">Danger</button>
<button disabled="" class="mb-2 mr-2 btn btn-focus disabled">Focus</button>
<button disabled="" class="mb-2 mr-2 btn btn-alternate disabled">Alt</button>
<button disabled="" class="mb-2 mr-2 btn btn-light disabled">Light</button>
<button disabled="" class="mb-2 mr-2 btn btn-dark disabled">Dark</button>
<button disabled="" class="mb-2 mr-2 btn btn-link disabled">link</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="mb-2 mr-2 btn btn-primary btn-lg btn-block">Block Large</button>
<button class="mb-2 mr-2 btn btn-primary btn-block">Block Normal</button>
<button class="mb-2 mr-2 btn btn-primary btn-sm btn-block">Block Small</button>
</div>
</div>
</div>
<div class="col-lg-6">
...
<button class="btn-wide mb-2 mr-2 btn btn-primary btn-lg">Wider Large</button>
<button class="btn-wide mb-2 mr-2 btn btn-primary">Wider Normal</button>
<button class="btn-wide mb-2 mr-2 btn btn-primary btn-sm">Wider Small</button>
</div>
</div>
</div>
<div class="main-card mb-3 card">
...
<div class="text-center">
<button class="mb-2 mr-2 btn btn-primary btn-lg">Large</button>
<button class="mb-2 mr-2 btn btn-primary">Normal</button>
<button class="mb-2 mr-2 btn btn-primary btn-sm">Small</button>
</div>
</div>
</div>
</div>
...
<button type="button" class="btn btn-alternate">One</button>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
 <button class="ladda-button mb-2 mr-2 btn btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-outline-2x btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-secondary" data-style="expand-right">
 <span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-success" data-style="expand-up">
 <span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-dashed btn-outline-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-primary" data-style="expand-left">
<span class="ladda-label">Expand Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-secondary" data-style="expand-right">
<span class="ladda-label">Expand Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-focus" data-style="zoom-in">
<span class="ladda-label">Zoom In</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-alternate" data-style="zoom-out">
<span class="ladda-label">Zoom Out</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-light" data-style="slide-left">
<span class="ladda-label">Slide Left</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-dark" data-style="slide-right">
<span class="ladda-label">Slide Right</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-danger" data-style="slide-up">
<span class="ladda-label">Slide Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-warning" data-style="slide-down">
<span class="ladda-label">Slide Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
...
<div class="text-center row">
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-success" data-style="expand-up">
<span class="ladda-label">Expand Up</span>
<span class="ladda-spinner"></span>
</button>
</div>
<div class="col-md-3">
<button class="ladda-button mb-2 mr-2 btn btn-gradient-info" data-style="expand-down">
<span class="ladda-label">Expand Down</span>
<span class="ladda-spinner"></span>
</button>
</div>
