    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Reporting Loan Balances
                    <div class="page-title-subheading">Reporting loans.</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mb-3 card">
                ...
                <div class="card-body">
                    ...
                    <table style="width: 100%;" id="dt-loans" class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($this->loan->all() as $key => $row) {
...
<?php app_footer() ?>
<?php page_end() ?>
<script src="<?= base_url('assets/js/reportings/loans.js?v=' . uniqid()); ?>" defer></script>
<?php app_end(); ?>