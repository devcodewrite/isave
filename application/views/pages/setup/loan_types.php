...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <table style="width: 100%;" id="dt-loan-types" class="table table-hover table-striped table-bordered">
...
<?php app_footer() ?>
<?php page_end() ?>
<script src="<?= base_url('assets/js/setup/loan-types.js?v=' . uniqid()) ?>" defer></script>
<?php app_end(); ?>