...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Repayment Transactions
                    <div class="page-title-subheading">Table of repayments and their details.</div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header">
            <i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Repayment Filter
...
<?php app_footer() ?>
<?php page_end() ?>
<script src="<?= base_url('assets/js/loans/repayment.js?v=1') ?>" defer></script>
<?php app_end(); ?>