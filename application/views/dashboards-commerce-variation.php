...
<li class="nav-item">
<a role="tab" class="nav-link" href="dashboards-commerce.html">
<span>Variation 1</span>
</a>
</li>
<li class="nav-item">
<a role="tab" class="nav-link active" href="dashboards-commerce-variation.html">
...
<div class="widget-title ml-md-2 opacity-5 font-size-lg text-muted">
...
<div>
<h5 class="menu-header-title text-capitalize text-primary">Simple Table</h5>
</div>
...
<td class="text-center">
<div class="progress-bar-xs progress">
<div class="progress-bar bg-primary" role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100" style="width: 67%;">
</div>
</div>
</td>
<td class="text-center">
