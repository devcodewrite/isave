...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/elements-navigation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jan 2023 17:00:15 GMT -->
<head>
<meta charset="utf-8">
...
<li>
<a href="elements-navigation.html" class="mm-active">
...
<div class="page-title-subheading">Navigation menus are one of the basic building blocks for any web or mobile app.</div>
</div>
</div>
...
<div class="card-body">
<h5 class="card-title">Grid Menu Hover Color</h5>
<div class="grid-menu grid-menu-3col">
<div class="no-gutters row">
<div class="col-sm-6 col-xl-4">
...
<button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2 dropdown-toggle btn btn-primary">Grid Menu Inside Dropdown
</button>
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Grid Menu Two Columns</h5>
<div class="grid-menu grid-menu-2col">
<div class="no-gutters row">
<div class="col-sm-6">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-primary">
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Grid Menu Bigger</h5>
<div class="grid-menu grid-menu-3col">
<div class="no-gutters row">
<div class="col-sm-6 col-xl-4">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="card-title">Grid Menu Bigger Two Columns</h5>
<div class="grid-menu grid-menu-2col">
<div class="no-gutters row">
<div class="col-sm-6">
<button class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="pb-3 card-title">Menu Headers</h5>
<div class="row">
<div class="col-md-3">
<div class="dropdown-menu-header">
<div class="dropdown-menu-header-inner bg-primary">
...
<div class="menu-header-image opacity-1" style="background-image: url('assets/images/dropdown-header/abstract10.jpg');">
</div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
...
<li class="nav-item-header nav-item">Activity</li>
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon pe-7s-chat">
</i><span>Chat</span>
<div class="ml-auto badge badge-pill badge-info">8</div>
</a>
</li>
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon pe-7s-wallet">
</i><span>Recover Password</span>
</a>
</li>
<li class="nav-item-header nav-item">My Account</li>
<li class="nav-item">
...
<div class="menu-header-image opacity-8" style="background-image: url('assets/images/dropdown-header/abstract3.jpg');">
</div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
...
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link">
<i class="nav-link-icon pe-7s-wallet">
</i><span>Recover Password</span>
 </a>
</li>
<li class="nav-item-header nav-item">My Account</li>
...
<div class="menu-header-image opacity-3" style="background-image: url('assets/images/dropdown-header/abstract4.jpg');"></div>
<div class="menu-header-content">
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options</h6>
</div>
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="pb-3 card-title">Menu Header Buttons Solid Backgrounds</h5>
<div class="row">
<div class="col-md-4">
<div class="dropdown-menu-header">
<div class="dropdown-menu-header-inner bg-warning">
...
<div>
<h5 class="menu-header-title">Settings</h5>
<h6 class="menu-header-subtitle">Manage all of your options
</h6>
</div>
<div class="menu-header-btn-pane">
 <button class="mr-2 btn btn-dark btn-sm">Settings</button>
...
<div class="main-card mb-3 card">
<div class="card-body">
<h5 class="pb-3 card-title">Headers Gradient Background with Images</h5>
<div class="row">
<div class="col-md-3">
<div class="dropdown-menu-header">
<div class="dropdown-menu-header-inner bg-mean-fruit">
<div class="menu-header-image" style="background-image: url('assets/images/dropdown-header/abstract2.jpg');">
</div>
<div class="menu-header-content">
<div>
<h5 class="menu-header-title">Settings</h5>
...
<i class="nav-link-icon pe-7s-settings"> </i><span>Link</span>
</a>
<a href="javascript:void(0);" class="nav-link">
<i class="nav-link-icon pe-7s-wallet"> </i><span>Link</span>
...
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link active">
<i class="nav-link-icon pe-7s-settings"> </i><span>Justified</span>
</a>
</li>
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link">
<i class="nav-link-icon pe-7s-chat"> </i><span>Link</span>
...
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link active">
<i class="nav-link-icon pe-7s-settings"> </i>Justified
</a>
</li>
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link">
<i class="nav-link-icon pe-7s-chat"> </i>Link
<div class="badge badge-success">NEW</div>
</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a disabled="" href="javascript:void(0);" class="nav-link disabled">
<i class="nav-link-icon pe-7s-box1"> </i>Disabled Link
</a>
</li>
</ul>
</div>
