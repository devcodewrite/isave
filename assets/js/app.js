...
window.readURL = function (input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.photo-placeholder').attr('src', e.target.result);
    };
...
window.formatPeopleResult = function (data) {
  ...
  var $container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="select2-result-user py-3" style="display:flex; flex-direction:row">' + '<img class="select2-result-user__avatar h-6 mr-2" src="' + data.getAvatar() + '">' + '<span class="select2-result-user__text text-uppercase">' + data.text + "</span>" + "</div>");
  return $container;
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkisave"] = self["webpackChunkisave"] || [];
